package app.nopcommerce.pageObjects;
...
import app.nopcommerce.utilities.WaitHelper;
...
public class SearchCustomerPage {
	...
	public boolean searchCustomerByName(String Name) {
		...
		for (int i = 1; i <= getNoOfRows(); i++) {
			...
			String [] Rn = name.split(" ");

			if (Name.contains(" ")) {
				String [] En = Name.split(" ");
				
				if (En[0].equals(Rn[0]) && En[1].equals(Rn[1])) {
